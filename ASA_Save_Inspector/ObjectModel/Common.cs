...
{
    public class TypeStringValue : IComparable, IComparable<TypeStringValue>
    {
        ...
        public int CompareTo(TypeStringValue? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));

        public override string ToString() => (value ?? string.Empty);
    }

    public class TypeIntValue : IComparable, IComparable<TypeIntValue>
    {
        public string? type { get; set; }
        ...
        public int CompareTo(TypeIntValue? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));

        public override string ToString() => (value != null && value.HasValue ? value.Value.ToString(CultureInfo.InvariantCulture) : string.Empty);
    }

    public class NameStringValue : IComparable, IComparable<NameStringValue>
    {
        ...
        public int CompareTo(NameStringValue? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));

        public override string ToString() => (value ?? string.Empty);
    }

    public class TypeObjectValue : IComparable, IComparable<TypeObjectValue>
    {
        public string? type { get; set; }
        ...
        public int CompareTo(TypeObjectValue? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));

        public override string ToString() => (value?.ToString() ?? string.Empty);
    }

    public class Vector : IComparable, IComparable<Vector>
    {
        ...
        public int CompareTo(Vector? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));
    ...
    public class Quaternion : IComparable, IComparable<Quaternion>
    {
        public double? x { get; set; }
        public double? y { get; set; }
        public double? z { get; set; }
        ...
        public int CompareTo(Quaternion? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));
    ...
    public class Rotator : IComparable, IComparable<Rotator>
    {
        ...
        public int CompareTo(Rotator? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));
    ...
    public class LinearColor : IComparable, IComparable<LinearColor>
    {
        ...
        public int CompareTo(LinearColor? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));
    ...
    public class ItemID : IComparable, IComparable<ItemID>
    {
        ...
        public int CompareTo(ItemID? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));
    ...
    public class Property : IComparable, IComparable<Property>
    {
        ...
        public int CompareTo(Property? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));

        public override string ToString() => $"name={(name ?? string.Empty)} type={(type ?? string.Empty)} value={(value ?? string.Empty)}";
    }

    public class Properties : IComparable, IComparable<Properties>
    {
        public CustomList<Property>? properties { get; set; }

        public int CompareTo(object? obj) => string.Compare(this.ToString(), (obj != null ? obj.ToString() : string.Empty));

        public int CompareTo(Properties? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));

        public override string ToString() => (properties != null && properties.Count > 0 ? string.Join(", ", properties) : string.Empty);
    }

    public class BytesArray : IComparable, IComparable<BytesArray>
    {
        ...
        public int CompareTo(BytesArray? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));
    ...
    public class CustomItemData : IComparable, IComparable<CustomItemData>
    {
        ...
        public int CompareTo(CustomItemData? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));

        public override string ToString() => $"{custom_data_name ?? string.Empty} [{strings}] [{floats}] [{doubles}]";
    }

    public class DinoID : IComparable, IComparable<DinoID>
    {
        public string? name { get; set; }
        ...
        public int CompareTo(DinoID? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));
    ...
    public class DinoAncestor : IComparable, IComparable<DinoAncestor>
    {
        ...
        public int CompareTo(DinoAncestor? other) => string.Compare(this.ToString(), (other != null ? other.ToString() : string.Empty));
