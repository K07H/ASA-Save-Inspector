...
namespace ASA_Save_Inspector
{
    ...
    public static class ASILang
    {
        ...
        private static readonly Dictionary<string, string> en_GB = new Dictionary<string, string>()
        {
            ...
            { "LegacySearch_Description", "Allows you to switch to the old search method (instead of using the new one)." },
            ...
            { "PythonVenvAddTestError", "Failed to create Python's virtual environment test script." },
        ...
        private static readonly Dictionary<string, string> fr_FR = new Dictionary<string, string>()
        {
            ...
            { "LegacySearch_Description", "Permet de basculer sur l'ancienne méthode de recherche (au lieu d'utiliser la nouvelle)." },
            ...
            { "PythonVenvAddTestError", "Erreur lors de la création du script de test de l'environnement virtuel Python." },
