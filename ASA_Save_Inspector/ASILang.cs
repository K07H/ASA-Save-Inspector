...
namespace ASA_Save_Inspector
{
    ...
    public static class ASILang
    {
        ...
        private static readonly Dictionary<string, string> en_GB = new Dictionary<string, string>()
        {
            ...
            { "IncludeVariablesWithMoreThanNValues", "Include variables with more than #VALUES_AMOUNT# values (not recommended)." },
            { "FilterBy", "Filter by" },
        ...
        private static readonly Dictionary<string, string> fr_FR = new Dictionary<string, string>()
        {
            ...
            { "IncludeVariablesWithMoreThanNValues", "Inclure les variables qui ont plus de #VALUES_AMOUNT# valeurs (non recommandé)." },
